...
Default behaviour (no call to :func:`configure_logging`):
    The ``"abb_rws_client_python_rw6"`` logger has **no handler and no level set**,
...
Typical usage — application code::
    ...
    from abb_rws_client_python_rw6import configure_logging
...
_ROOT_LOGGER_NAME: str = "abb_rws_client_python_rw6"
...
def configure_logging(
    ...
    the ``"abb_rws_client_python_rw6"`` logger and sets its level.  Calling this
    ...
    Returns:
        The configured ``"abb_rws_client_python_rw6"`` :class:`logging.Logger`
...
def get_logger(name: str) -> logging.Logger:
    """Return a child logger of ``"abb_rws_client_python_rw6"``.
    ...
    Example:
        ...
        Inside an example script::
            ...
            from abb_rws_client_python_rw6import get_logger
