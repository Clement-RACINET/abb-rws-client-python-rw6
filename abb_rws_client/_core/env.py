...
"""Environment configuration loader for abb-rws6-python-client.
...
:class:`~abb_rws_client.RWSClient`.

Environment variables recognised by :class:`~abb_rws_client.RWSClient`:
    ...
    *,
    ...
    Example:
        Automatic discovery from current working directory::
            ...
            from abb_rws_client import load_env
            load_env()
